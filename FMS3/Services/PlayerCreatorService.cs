    ...
    public class PlayerCreatorService : IPlayerCreatorService
    {
        ...
        private void SetInitialInjuries(List<Team> teamList)
        {
            ...
            for (var index = 1; index <= numInjuries; index++)
            {
                ...
                {
                    _playerService.SetTeamSelection(_teamService.Get(player.TeamId));
                }
        ...
        private IEnumerable<PlayerAttribute> CreateNewPlayerAttributes(Player player)
        {
            ...
            shooting += (player.Position * Utilities.Utilities.GetRandomNumber(1, 20));
            ...
            skills += (player.Position * Utilities.Utilities.GetRandomNumber(1, 20));
            ...
            passing += (player.Position * Utilities.Utilities.GetRandomNumber(1, 15));
